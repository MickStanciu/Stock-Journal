...
public class ShareDataRepository {
    ...
    private static final String SET_FOR_SYMBOL =
            "INSERT INTO fundamental (symbol, last_updated_on, sector, market_cap_b, p_e_ratio, future_p_e_ratio, book_value, eps, future_eps, price, finviz_target, p_e_future_target) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
