...
import com.example.gateway.api.core.service.AuthService
...
class AuthenticationController(private val accountService: AccountService, private val authService: AuthService) {
    ...
    fun authenticate(@RequestBody authRequestDto: GWAuthRequestDto): GWAuthResponseDto {
        ...
        val token = authService.generateToken(activeAccount.id)
