...
public class TransactionSettinsModelConverter {
    public static Function<com.example.tradelog.api.proto3.model.TransactionSettingsModel, com.example.tradelog.api.core.model.TransactionSettingsModel> toModel = protoModel -> {
    ...
    public static Function<com.example.tradelog.api.core.model.TransactionSettingsModel, com.example.tradelog.api.proto3.model.TransactionSettingsModel> toProto = apiModel -> {
