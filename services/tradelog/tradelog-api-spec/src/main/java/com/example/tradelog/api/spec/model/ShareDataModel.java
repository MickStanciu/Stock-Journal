...
public class ShareDataModel implements Serializable {
    ...
    public static Builder builder(ShareDataModel existingModel) {
        return new Builder(existingModel);
    }
    ...
    public static class Builder {
        ...
        public Builder() {
            model = new ShareDataModel();
        }

        public Builder(ShareDataModel model) {
            this.model = model;
        }

        public ShareDataModel build() {
            ShareDataModel buildModel = this.model;
            this.model = new ShareDataModel();
            return buildModel;
        }
