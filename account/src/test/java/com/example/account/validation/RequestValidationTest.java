...
public class RequestValidationTest {
    ...
    public void testValidateUpdateAccountWhenValid() {
        Role roleFixture = new Role(5, "L5", "");
        Account accountFixture = new Account(DEFAULT_TENAND_ID, DEFAULT_ACCOUNT_ID, roleFixture, DEFAULT_ACCOUNT_NAME,
                DEFAULT_ACCOUNT_EMAIL, DEFAULT_ACCOUNT_PASSWORD, true);
        boolean response = validateUpdateAccount(DEFAULT_TENAND_ID, DEFAULT_ACCOUNT_ID, accountFixture);
        assertTrue("Should be TRUE", response);
    }
    ...
    public void testValidateUpdateAccountWhenAccountIdIsInvalid() {
        ...
        boolean response = validateUpdateAccount(DEFAULT_TENAND_ID, null, accountFixture);
        assertFalse("Should be FALSE", response);
    }
    ...
    public void testValidateUpdateAccountWhenAccountIsInvalid() {
        Role roleFixture = new Role(5, "L5", "");
        Account accountFixture = new Account(DEFAULT_TENAND_ID, DEFAULT_ACCOUNT_ID, roleFixture, null,
                DEFAULT_ACCOUNT_EMAIL, DEFAULT_ACCOUNT_PASSWORD, true);
        boolean response = validateUpdateAccount(DEFAULT_TENAND_ID, DEFAULT_ACCOUNT_ID, accountFixture);
        assertFalse("Should be FALSE", response);

        accountFixture = new Account(DEFAULT_TENAND_ID, DEFAULT_ACCOUNT_ID, roleFixture, DEFAULT_ACCOUNT_NAME,
                null, DEFAULT_ACCOUNT_PASSWORD, true);
        response = validateUpdateAccount(DEFAULT_TENAND_ID, DEFAULT_ACCOUNT_ID, accountFixture);
        assertFalse("Should be FALSE", response);
